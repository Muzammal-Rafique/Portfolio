      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 pt-16 pl-6">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            Passionate Next JS Developer, committed to advancing web
            development.
          </p>
          <div>
            <Link
            ...
            <Link
              href="https://drive.google.com/file/d/1x66pAJa_RhjLRhDp00AX1SH20KnfYbjp/view?usp=sharing" target="_blank"
